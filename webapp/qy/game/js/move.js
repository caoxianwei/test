...
move.local = location.toString().indexOf("/qyGame")>-1?0:1;
move.server="http://"+window.location.host+(move.local?"":"/qyGame");
move.webpath=move.local?"":"/qyGame";

// move.local = 'http://www.qycp58.com'.indexOf("/qyGame")>-1?0:1;
// move.server='http://www.qycp58.com'+(move.local?"":"/qyGame");
// move.webpath=move.local?"":"/qyGame";
