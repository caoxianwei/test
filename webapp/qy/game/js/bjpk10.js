		...
		$.ajax({
			...
			success: function(ret){
				...
				if(code=='200'){
					...
					if(timerxiazhu==null){
						timerxiazhu=window.setInterval(function(){timerObj.init(timerObj.rest,'timer-bj');},timerObj.interval); 
					}
					if(timeropen==null){
						timeropen=window.setInterval(function(){timerObj.open(timerObj.openrest,'timer-bjopen');},timerObj.interval);
					}
				}
