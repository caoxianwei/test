    ...
    function getBetZjDetails(){
        ...
        ajaxRequest({
            ...
            beforeSend: function() {
                ...
                $(container).html('<li style="width:100%;padding:15px;text-align:center;" id="BetLogin"> 请先&nbsp;&nbsp;<span class="spanlogin">登录</span>&nbsp;&nbsp;还没有帐号？&nbsp;&nbsp;<span class="spanreg"><a href="../../register/index/register.html" target="_blank">注册</a></span>一个</li>');
            ...
            success: function(json) {
                ...
                if (json.code != 200) {
                    $(container).html('<li style="width:100%;padding:15px;text-align:center;" id="BetLogin"> 请先&nbsp;&nbsp;<span class="spanlogin">登录</span>&nbsp;&nbsp;还没有帐号？&nbsp;&nbsp;<span class="spanreg"><a href="../../register/index.html" target="_blank">注册</a></span>一个</li>');
