    ...
    Fullscreen.prototype = {
        ...
        revert: function(){
            ...
            var options = this.editor.options,
                height = /%$/.test(options.initialFrameHeight) ?  '300' : (options.initialFrameHeight - this.getStyleValue("padding-top")- this.getStyleValue("padding-bottom") - this.getStyleValue('border-width'));
