(function () {
    ...
    UM.registerWidget(widgetName, {
        tpl: "<style type=\"text/css\">" +
            ...
            ".edui-dialog-map .edui-map-city{width:80px}" +
            ".edui-dialog-map .edui-map-address{width:120px}" +
            ...
            "<td><input class=\"edui-map-dynamic\" type=\"checkbox\" checked='checked' name=\"edui-map-dynamic\" /><span><%=lang_dynamicmap%></span></td>"+
            "</tr>" +
            "</table>" +
        ...
        buttons: {
            ok: {
                exec: function (editor) {
                    ...
                    var center = widget.map.mc;
                    var zoom = widget.map.getZoom();
                    var size = widget.map.getSize();
                    var point = widget.marker.point;
                    console.log(widget);
