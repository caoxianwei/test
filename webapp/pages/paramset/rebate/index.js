...
function loadSessionInfoTree(){
	var dpArr = "[";
	var gpArr = "[";
	var url = $.getContextPath() + "gaBetOption/gotoRebateView.do?";
	...
	$("#sessionInfoTree").tree({
		...
		onClick:function(node){
			...
			var play_type = "0";
			if(game_type=="12"){
				//六合彩查询特码B的玩法，目前六合彩之后特码B设置返点
				play_type = "1";
			}
			$("#plwf").attr("src",$.getContextPath() +"gaBetOption/gotoRebateView.do?gameType=" + game_type+"&play_type=" + play_type);
		}
	});
